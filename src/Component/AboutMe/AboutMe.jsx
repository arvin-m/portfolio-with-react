            ...
            <div className="container" id="mainContainer">
                <div className="row justify-content-start ">
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <p className="paragraph">My name is Arvin. I was born on September 21,1985 in a small town
                        named,Baneh, just west of Iran. In 2007, I graduated with an associate degree for computer
                        software. At the end of 2016, I had the opportunity to move to the United
                ...
                <div className="row justify-content-start">
                    <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        that missing of my life.
                        I have finally gotten back on track! I have managed
                        the time and resources to study as a Full Stack Web Developer at Georgia Tech Bootcamp. Life
